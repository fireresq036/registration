...
<form method="post" id="event_form"
      onsubmit="return validateForm(['name_str', 'description_str',
                                     'location_str', 'startDate_date',
                                     'endDate_date', 'teamSize_num']);"
  <c:if test="${add_event}">
...
>
    ...
    <div class="wrapper">
        <div id="name_div">
            Event Name:
            <input id="name_str" type="text" name="eventName" value="${edit_event.name}"
                   onBlur="validateString(this, 'submit_button')"/>
        </div>
        <div id="name_error"></div>
        <div id="description_div">
            Event Description:
            <input id="description_str" type="text" name="eventDescription" value="${edit_event.description}"
                   onBlur="validateString(this, 'submit_button')"/>
        </div>
        <div id="description_error"></div>
        <div id="location_div">
            Event Location:
            <input id="location_str" type="text" name="eventLocation" value="${edit_event.location}"
                   onBlur="validateString(this, 'submit_button')"/>
        </div>
        <div id="location_error"></div>
        <div id="startDate_div">
            Event Start Date (mm/dd/yyy):
            <input id="startDate_date" type="text" name="eventStartDate" value="${formatedStartDate}"
                   onBlur="validateDate(this, 'submit_button')"/>
        </div>
        <div id="startDate_error" ></div>
        <div id="endDate_div">
            Event End Date (mm/dd/yyy):
            <input id="endDate_date" type="text" name="eventEndDate" value="${formatedEndDate}"
                   onBlur="validateDate(this, 'submit_button')"/>
        </div>
        <div id="endDate_error"></div>
        <div id="teamSize_div">
            Size of Team for Event:
            <input id="teamSize_num" type="text" name="eventTeamSize" value="${edit_event.teamSize}"
